...
<div class="lwa lwa-srd"><?php //class must be here, and if this is a template, class name should be that of template directory ?>
      ...
      <table>
        ...
        <tr class="lwa-submit">
          ...
          <td class="lwa-submit-links">
            <input name="rememberme" type="checkbox" class="lwa-rememberme" value="forever" /> <label for="rememberme"><?php esc_html_e( 'Remember Me','login-with-ajax' ) ?></label><br />
  ...
  <?php if( get_option('users_can_register') && !empty($lwa_data['registration']) && $lwa_data['registration'] == 1 ): ?>
    <div class="lwa-register lwa-register-srd lwa-modal" style="display:none;">
